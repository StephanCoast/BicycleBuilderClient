...
public class SVGManager {
    ...
    public static final String FRAME1_COLOR = "#056b5c";
    public static final String SEAT1_COLOR = "#5F9EA0";
    public static final String TIRE1_COLOR = "#81c483";
    public static final String HANDLEBAR1_COLOR = "#a60793";
    // SET 2
    ...
    public static final String FRAME2_COLOR = "#8A2BE2";
    public static final String SEAT2_COLOR = "#de9918";
    public static final String TIRE2_COLOR = "#81c483";
    public static final String HANDLEBAR2_COLOR = "#086148";
    // SET 3
    ...
    public static final String FRAME3_COLOR = "#9781c4";
    public static final String SEAT3_COLOR = "#ed4a13";
    public static final String TIRE3_COLOR = "#81c3c4";
    public static final String HANDLEBAR3_COLOR = "#1328a1";

    public SVGManager() {
        svgStringList = FXCollections.observableArrayList(FRAME1, FRAME1_COLOR, SEAT1, SEAT1_COLOR, TIRE1, TIRE1_COLOR, HANDLEBAR1, HANDLEBAR1_COLOR);
    }
    ...
    public void setFrame(String frameString, String frameColor) {
        svgStringList.set(0, frameString);
        svgStringList.set(1, frameColor);
    }

    public void setSeat(String seatString, String seatColor) {
        svgStringList.set(2, seatString);
        svgStringList.set(3, seatColor);
    }

    public void setTire(String tireString, String tireColor) {
        svgStringList.set(4, tireString);
        svgStringList.set(5, tireColor);
    }

    public void setHandlebar(String hbString, String hbColor) {
